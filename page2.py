    ...
    def __init__(self):
        ...
        self.content = ft.Column(     
            controls=[        
                ...
                ft.Row(
                    controls=[                       
                        ActionButton(text="lnx", button_clicked=self.button_clicked), 
                        ActionButton(text="x³", button_clicked=self.button_clicked),
                        ActionButton(text="lgb", button_clicked=self.button_clicked),  
        ...
        if operator == "+":            
           return self.format_number(operand1 + operand2)
            ...
            if operand1 == 0:
                ...
                return self.format_number(math.log10(float(operand1)))                               
        elif operator == "%":
